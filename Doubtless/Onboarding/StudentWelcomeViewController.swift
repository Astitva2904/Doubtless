...
final class StudentWelcomeViewController: UIViewController {
    ...
    private func setupButtons() {
        ...
        createButton.setTitle("Create Student Account", for: .normal)
        ...
        NSLayoutConstraint.activate([
            ...
            // No strict bottom anchor here; dynamic top anchor on the bottom image will push the buttons up
        ])
    }
