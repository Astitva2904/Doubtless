...
final class StudentOnboardingViewController: UIViewController {
    ...
    private let pages: [Page] = [
        Page(
            image: "Student Onboarding 1",
            text: "Have a doubt?",
            button: "NEXT"
        ),
        Page(
            image: "Student Onboarding 2",
            text: "Click a photo and Upload",
            button: "NEXT"
        ),
        Page(
            image: "Student Onboarding 3",
            text: "Connect with a solver and get live one-on-one help",
            button: "START"
        )
    ]
    ...
    private func finishOnboarding() {
        ...
        let tabBarController = MainTabBarControllerStudent()
