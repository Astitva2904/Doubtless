...
// MARK: - SolverAllSolvedDoubtsViewController
/// Shows the full list of solved doubts for the current solver.
final class SolverAllSolvedDoubtsViewController: UIViewController {
    ...
    private func loadData() {
        Task {
            if let items = try? await SupabaseManager.shared.fetchSolverRecentActivity(solverName: solverName, limit: 100) {
