...
final class SolverNotificationsViewController: UIViewController {
    ...
    private func setupContent() {
            ...
            // MARK: - Solver Relevant Sections

            stackView.addArrangedSubview(makeSection(
                title: "Doubt Updates",
                items: [
                    ("New Doubt Notifications", true),
                    ("Student Cancellations", true),
                    ("Action Reminders", true)
                ])
            )
            ...
            stackView.addArrangedSubview(makeSection(
                ...
                items: [
                    ...
                    ("Session Milestones", true),
                    ("Weekly Activity Summary", true)
                ])
            )
            ...
            stackView.addArrangedSubview(makeSection(
                ...
                items: [
                    ("Status Reminders", false),
                    ("Peak-Hour Alerts", true),
                    ("Inactivity Warnings", true)
                ])
            )
